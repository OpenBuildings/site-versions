...
INSERT INTO `users` (`id`, `email`, `username`, `password`, `logins`, `last_login`, `facebook_uid`, `twitter_uid`, `last_login_ip`, `current_purchase_id`)
VALUES
  (1,'admin@example.com','admin','f02c9f1f724ebcf9db6784175cb6bd82663380a5f8bd78c57ad20d5dfd953f15',5,1374320224,'facebook-test','','10.20.10.1',1),
  (2,'user@example.com','user','f02c9f1f724ebcf9db6784175cb6bd82663380a5f8bd78c57ad20d5dfd953f15',3,1374320224,'facebook-test2','','10.20.10.2',NULL);

INSERT INTO `visitors` (`id`, `user_id`, `purchase_id`, `country_id`, `token`, `ip`, `currency`)
VALUES
  (1,1,1,3,'f02c9f1f724ebcf9db6784175cb6bd82663380a5f8bd78c57ad20d5dfd953f15','10.20.10.1','EUR');
